...
| 8 | Reflected XSS into JavaScript string with angle brackets HTML-encoded | [Report](reports/Reflected-XSS-JS-String.md) | [Report](reports/Stored-XSS-href.md) | [1](screenshots/Reflected-XSS-JS-String-1.png) [2](screenshots/Reflected-XSS-JS-String-2.png |
